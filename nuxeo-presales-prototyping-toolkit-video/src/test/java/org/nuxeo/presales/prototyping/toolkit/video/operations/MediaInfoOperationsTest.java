...
@Deploy({"org.nuxeo.ecm.platform.commandline.executor","org.nuxeo.presales.prototyping.toolkit.video"})
public class MediaInfoOperationsTest {
	...
	public void shouldGetAllProcessedInfos() throws Exception {
		...
		assertEquals(testResult.get("General").get("Format/Info"),"Audio Video Interleave");
		assertEquals(testResult.get("General").get("Format"),"AVI");
		assertEquals(testResult.get("General").get("Writing application"),"Lavf52.31.0");
		assertEquals(testResult.get("General").get("Writing application"),"Lavf52.31.0");
		assertEquals(testResult.get("Video").get("ID"),"0");
		assertEquals(testResult.get("Video").get("Writing library"),"Lavc52.20.0");
		assertEquals(testResult.get("Audio").get("Interleave, preload duration"),"24 ms");
