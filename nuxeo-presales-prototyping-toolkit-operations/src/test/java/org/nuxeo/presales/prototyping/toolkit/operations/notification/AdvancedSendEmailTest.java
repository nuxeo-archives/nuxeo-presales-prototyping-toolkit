...
@Deploy({ "org.nuxeo.ecm.automation.core",
        ...
        "org.nuxeo.presales.prototyping.toolkit.operation", "org.nuxeo.ecm.directory",
        "org.nuxeo.ecm.directory.sql", "org.nuxeo.ecm.directory.types.contrib",
        "org.nuxeo.ecm.platform.usermanager.api",
        "org.nuxeo.ecm.platform.usermanager",
        "org.nuxeo.presales.prototyping.toolkit.operation.test:OSGI-INF/doc-type-contrib.xml",
        "org.nuxeo.presales.prototyping.toolkit.operation.test:OSGI-INF/directory-config.xml",
        "org.nuxeo.presales.prototyping.toolkit.operation.test:OSGI-INF/userservice-config.xml" })
