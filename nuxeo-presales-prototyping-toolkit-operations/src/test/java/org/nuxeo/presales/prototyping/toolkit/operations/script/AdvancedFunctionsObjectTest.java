 ...
 */
package org.nuxeo.presales.prototyping.toolkit.operations.script;

import static junit.framework.Assert.assertEquals;
import static org.nuxeo.presales.prototyping.toolkit.operations.scripting.AdvancedFunctionsObject.concatenateValues;
 ...
 * @since 5.7
 */
public class AdvancedFunctionsObjectTest {
    ...
    public void shouldConcatenateWithStringScalar() throws ClientException {
        List<String> result = concatenateValues(listOfString, stringValue1);
    ...
    public void shouldConcatenateWithIntegerScalar() throws ClientException {
        List<Integer> result = concatenateValues(listOfInteger, intValue1);
        assertEquals(3, result.size());
    ...
    public void shouldConcatenateListString() throws ClientException {
        List<String> result = concatenateValues(listOfString, arrayOfString,
                stringValue1);
    ...
    public void shouldConcatenateListInteger() throws ClientException {
        List<Integer> result = concatenateValues(listOfInteger, arrayOfInteger,
                intValue1);
        assertEquals(5, result.size());
        assertEquals(new Integer(-1), result.get(0));
        assertEquals(new Integer(-2), result.get(1));
